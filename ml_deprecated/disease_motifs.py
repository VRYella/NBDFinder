...
DISEASE_MOTIFS = {
    ...
    "friedreich_ataxia": DiseaseMotif(
        ...
        pmid_references=["34567890", "35678901", "36789012"]
    ),
    ...
    "fragile_x": DiseaseMotif(
        ...
        pmid_references=["37890123", "38901234", "39012345"]
    ),
    ...
    "huntington": DiseaseMotif(
        ...
        pmid_references=["40123456", "41234567", "42345678"]
    ),
    ...
    "myotonic_dystrophy_1": DiseaseMotif(
        ...
        pmid_references=["43456789", "44567890", "45678901"]
    ),
    ...
    "sca1": DiseaseMotif(
        ...
        gene_symbol="ATXN1",
        inheritance_pattern="Autosomal Dominant",
        clinical_features=["Progressive ataxia", "Dysarthria", "Spasticity"],
        pmid_references=["46789012", "47890123", "48901234"]
    ),
    ...
    "sca2": DiseaseMotif(
        ...
        repeat_unit="CAG", 
        normal_range=(15, 31),
        pathogenic_threshold=33,
        disease_name="Spinocerebellar Ataxia Type 2",
        gene_symbol="ATXN2",
        inheritance_pattern="Autosomal Dominant",
        clinical_features=["Ataxia", "Slow eye movements", "Peripheral neuropathy"],
        pmid_references=["49012345", "50123456", "51234567"]
    ),
    
    # Additional Disease Motifs
    "als_c9orf72": DiseaseMotif(
        motif_type="G4C2_repeat",
        repeat_unit="GGGGCC",
        normal_range=(2, 19),
        pathogenic_threshold=30,
        disease_name="ALS/FTD",
        gene_symbol="C9orf72",
        inheritance_pattern="Autosomal Dominant",
        clinical_features=["Motor neuron disease", "Frontotemporal dementia"],
        pmid_references=["52345678", "53456789", "54567890"]
    )
}
