...
def find_slipped_dna(seq):
    """
    Find slipped DNA structures including direct repeats and short tandem repeats.
    
    Enhanced Scoring System:
    1. Direct Repeats: Unit length × composition weight (AT-rich repeats more flexible)
    2. STRs: Length × GC factor × copy number scaling for stability assessment
    3. Overlap prevention to avoid redundant detections
    ...
    Returns:
    list: List of slipped DNA motif dictionaries
    """
    results = []
    min_len_dr = 10
    max_len_dr = 300
